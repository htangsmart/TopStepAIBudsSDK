...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../AWEISIMG_SDK.framework"
  install_framework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/SJCoreImp/h264encoder.framework"
  install_framework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/SJCoreImp/opus-ios.framework"
  install_framework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/SJCoreImp/SJWatchLib.framework"
  install_framework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/SJCoreImp/TLOCP.framework"
  install_framework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/SJCoreImp/UNIWatchMate.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TopStepAIBudsSDK/TopStepABMateSDK.framework"
