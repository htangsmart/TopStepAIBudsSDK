...
install_xcframework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/SJCoreImp/TopStepSJWatchKit.xcframework" "TopStepComKit-Git/SJCoreImp" "framework" "ios-arm64"
