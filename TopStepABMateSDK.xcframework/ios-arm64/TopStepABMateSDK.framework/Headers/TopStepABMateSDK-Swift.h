...
@class NSDate;
@class NSString;
@interface AIRecord (SWIFT_EXTENSION(TopStepABMateSDK))
...
SWIFT_CLASS("_TtC16TopStepABMateSDK19TSStartBurstManager")
...
@interface TSStartBurstManager (SWIFT_EXTENSION(TopStepABMateSDK))
...
@interface TSStartBurstManager (SWIFT_EXTENSION(TopStepABMateSDK))
/// 手机拾音并翻译
- (void)translateByVoiceFromLan:(NSString * _Nullable)fromLan targetLan:(NSString * _Nullable)targetLan recognizeText:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull, NSDictionary<NSString *, id> * _Nonnull))recognizeText ttsCallback:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))ttsCallback error:(void (^ _Nonnull)(NSError * _Nullable))error;
/// 停止手机拾音
...
- (void)startABMetaMultiAIChatWithResult:(void (^ _Nonnull)(NSError * _Nullable))result;
- (void)stopABMetaMultiAIChatWithResult:(void (^ _Nonnull)(NSError * _Nullable))result;
/// 开启多模态AI对话（眼镜）
/// <ul>
///   <li>
///     intent: 解析到意图时的回调
///   </li>
/// </ul>
- (void)startMultiAIChatWithStateChanged:(void (^ _Nonnull)(enum TSAIState))stateChanged result:(void (^ _Nonnull)(NSInteger, BOOL, NSString * _Nonnull, NSString * _Nonnull, BOOL))result error:(void (^ _Nonnull)(NSError * _Nonnull))error intent:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable))intent;
- (void)stopMultiAIChatWithStateChanged:(void (^ _Nonnull)(enum TSAIState))stateChanged;
- (void)setSpeechRecognitionModeWithMode:(BOOL)mode result:(void (^ _Nonnull)(NSError * _Nullable))result;
@end
