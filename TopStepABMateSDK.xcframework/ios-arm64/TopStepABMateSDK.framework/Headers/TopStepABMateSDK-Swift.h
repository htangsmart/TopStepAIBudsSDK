...
- (void)getDeviceWorkStateWithResult:(void (^ _Nonnull)(uint8_t, NSError * _Nullable))result;
...
/// 单独设置一个设备音量 0系统音量 1媒体音量 2通话音量
- (void)setSingleDeviceVolumeWithType:(enum TSSBEarbudsDeviceVolumeSettingType)type volume:(uint8_t)volume result:(void (^ _Nonnull)(NSError * _Nullable))result;
/// 设备同时设置三个设备音量
- (void)setAllDeviceVolumeWithSystemVolume:(uint8_t)systemVolume mediaVolume:(uint8_t)mediaVolume callVolume:(uint8_t)callVolume result:(void (^ _Nonnull)(NSError * _Nullable))result;
@end
